...
public class UserThird implements ActionListener, Runnable {
    ...
    UserThird() {
        ...
        ImageIcon i4 = new ImageIcon(ClassLoader.getSystemResource("icons/Avengers.png"));
        ...
        JLabel name3 = new JLabel("Avengers");
        name3.setBounds(110, 15, 100, 18);
        name3.setForeground(Color.WHITE);
        name3.setFont(new Font("SAN_SERIF", Font.BOLD, 18));
        p1.add(name3);
        
        JLabel status = new JLabel("IronMan, Captain America, Thor, Hulk, Black Widow, Hawkeye");
